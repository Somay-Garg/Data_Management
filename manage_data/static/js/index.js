function addSponsors(spon) {
  ...
  let sponLabel = document.querySelector(".sponsors");
  let tmp = `
  <div class="sponsors" >
  ...
  $(function () {
    if(document.getElementsByClassName('event').length > 0){
      ...
      for (let i = 0; i < arr.length; i++) {
        ...
        let child = document.createElement("div");
        /* child.style.cssText = 'border:1px solid rgb(141, 140, 140);';
        child.setAttribute("class","mb-2"); */
        child.innerHTML = template;
...
//Infrastructure onload code starts---------------------------------------------------------------------------------------
  ...
  $(function () {
    ...
    for(let i=0;i<arr.length;i++){
      ...
      let template = ` 
      <br>
      <fieldset class="border border-2 p-3 edit_publishers" id="">
  ...
  $(function () {
        ...
        for (let i = 0; i < arr.length; i++) {
          ...
          let stu_parti = objarr[7][1];
            ...
            let template = `<br>
            <fieldset class="border border-2 p-3 tieup_edit_fields" id="">
