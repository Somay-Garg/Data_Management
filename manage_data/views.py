...
def edit_event(request,pk):
    ...
    if request.method == "POST":
        ...
        # item.type_of_event = type_of_event
        # item.Audience = Audience
        # item.Societies = Societies
        # item.Departments = Departments
        # item.Organized_by = Organized_by
        # item.Conducted_by = Departments
        # item.no_of_sponsors = no_of_sponsors
        # item.sponsors_details = sponsors_details
        # item.total_sponsored_amt = total_sponsored_amt
        # item.start_date = start_date
        # item.end_date = end_date
        # item.no_of_participants = no_of_participants
        ...
        return render(request,'edit_event.html',{'event_data':event_data})
...
def delete_entry(request,pk,model,header):
    ...
    path_atten = 'C:/Users/mansi/Desktop/python_Project/Data_Management/attendance/event_attendances/'+item.upload_attendance
    print(path_atten)
    fs_attendance.delete(path_atten)

    fs_report = FileSystemStorage(location='report/event_reports/')
    path_report = 'C:/Users/mansi/Desktop/python_Project/Data_Management/report/event_reports/'+item.upload_report
